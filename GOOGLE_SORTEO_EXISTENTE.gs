...
const MERCADOPAGO_ACCESS_TOKEN = 'TU_ACCESS_TOKEN_AQUI'; // ⚠️ REEMPLAZAR CON TU TOKEN REAL
...
/**
 * Sistema de referidos simplificado - solo captura el DNI referido
 * La validación se realiza manualmente por el administrador
 * El DNI referido se guarda en la columna "observaciones" con formato "REF:DNI_REFERIDO"
 */
