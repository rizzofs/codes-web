...
const MATERIAS_1714 = [
  // Talleres Introductorios (antes del 1er cuatrimestre)
  { code: '19054', name: 'Competencias Básicas en Informática (2) (7)' },
  { code: '39553', name: 'Competencias Básicas en Idioma Inglés (equivalente a niveles I y II) (2)' },
  { code: '14026', name: 'Taller Introductorio de Interpretación de Problemas (3)' },
  // 1er Cuatrimestre
