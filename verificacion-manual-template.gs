/**
 * Sistema de Verificación Manual de Pagos - TEMPLATE
...
const SPREADSHEET_ID = 'TU_SPREADSHEET_ID_AQUI'; // Reemplaza con tu ID de Google Sheet
const SHEET_NAME = 'TU_NOMBRE_DE_HOJA_AQUI'; // Reemplaza con el nombre de tu hoja
...
// ===========================================
/*
1. Reemplaza TU_SPREADSHEET_ID_AQUI con el ID de tu Google Sheet
2. Reemplaza TU_NOMBRE_DE_HOJA_AQUI con el nombre de la hoja donde guardar los datos
3. Copia este archivo a Google Apps Script
4. Ejecuta configurarTodo() para configurar el sistema completo
5. Ejecuta probarVerificacion() para probar manualmente
*/ 